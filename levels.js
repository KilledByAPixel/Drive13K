...
function initLevelInfos()
{
    ...
    ], trackSprites.tree_palm,trackSprites.horizon_islands);
    LI.waterSide = -1;
    ...
    ], trackSprites.tree_oak, trackSprites.horizon_smallMountains);
    LI.trackSideRate = 20;
    ...
    LI.cloudHeight = .3;
    LI.billboardRate = 20; // more billboards in city
    ...
    LI = new LevelInfo(level++, [
        ...
        trackSprites.tree_oak,
        trackSprites.tree_bush,
    ], trackSprites.tree_oak, trackSprites.horizon_brownMountains);
    LI.sceneryListBias = 1;
    LI.groundColor = hsl(.2,.3,.5);
    LI.trackSideRate = LI.laneCount = 0;
...
class LevelInfo
{
    constructor(level, scenery, trackSideSprite,horizonSprite=trackSprites.horizon_mountains)
    {
        // add self to list
